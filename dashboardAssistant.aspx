<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dashboardAssistant.aspx.cs" Inherits="dashboardAssistant" %>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">Add Members</div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-2 col-md-6">
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-12 text-right">
                                    <div class="huge">Edit Profile</div>
                                </div>
                            </div>
                        </div>
